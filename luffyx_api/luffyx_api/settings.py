"""
Django settings for luffyx_api project.
...
SECRET_KEY = '*9&jj&3qg)&ts13p)on9+#iao5kcqahn#ylvr+i%*=))ay$l$a'
...
WSGI_APPLICATION = 'luffyx_api.wsgi.application'
